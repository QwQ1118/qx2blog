...
<a href="/zh-cn/父级页面/" style="display:inline-block;margin-bottom:4px;color:var(--secondary);text-decoration:none;font-size:16px;">>>🤔我思故我在</a>
<h1 style="margin-top:0;margin-bottom:20px;font-size:2rem;">仰观宇宙之大</h1>

<p style="color: #999; font-size: 1rem; line-height: 1.7; margin-bottom: 2rem;">
  关于宇宙万物的一些哲思
</p>

<!-- 文章列表由 Hugo 自动生成，不需要任何 HTML -->