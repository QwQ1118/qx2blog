...
/* 终极精准隐藏：消除自动生成的post条目链接 */
.entry-link {
    display: none !important;
}
/* 隐藏 Hugo 自动生成的文章条目，保持卡片导航页纯净 */
.post-entry {
  display: none !important;
}
</style>
...
<h1 style="margin-top:0;margin-bottom:20px;font-size:2rem;">生活艺术</h1>
...
<div class="card-grid">
  <a class="card" href="/zh-cn/posts/巧夺天工/生活艺术/小设计/">
    <span class="card-icon">📐</span>
    <span class="card-title">小设计</span>
  </a>
  <a class="card" href="/zh-cn/posts/巧夺天工/生活艺术/杂七杂八/">
